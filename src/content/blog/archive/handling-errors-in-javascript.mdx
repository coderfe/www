...
import GlobalErrors from '../../../assets/blog/global-error-ui.jpg';
import HandleSpecificErrors from '../../../assets/blog/handling-specific-request-error.jpg';
import OriginErrors from '../../../assets/blog/frontend-origin-errors.jpg';
...
<img src={GlobalErrors.src} alt="UI for global errors" />
...
<img src={OriginErrors.src} alt="Handling specific request errors" />
...
<img src={OriginErrors.src} alt="Frontend origin errors" />
